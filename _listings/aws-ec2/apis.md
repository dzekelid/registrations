...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/registrations/master/_listings/aws-ec2/apis.md
...
- name: AWS EC2 API - Register Image
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/registrations/master/_listings/aws-ec2/actionregisterimage-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/registrations/master/_listings/aws-ec2/actionregisterimage-get-openapi.md
- name: AWS EC2 API - Register Image
  x-api-slug: actionregisterimage-get
  description: Registers an AMI.
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/Compute_AmazonEC2.png
