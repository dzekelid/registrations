...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/registrations/master/_listings/dezrez/apis.md
...
- name: Dezrez.Rezi.Client.Api - Gets the config back for a screen with a guid that
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/registrations/master/_listings/dezrez/apiscreenzconfigscreenid-get-openapi.md
- name: Dezrez.Rezi.Client.Api - Gets the config back for a screen with a guid that
    was registered against a branch
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/registrations/master/_listings/dezrez/apiscreenzregistered-get-openapi.md
- name: Dezrez.Rezi.Client.Api - Gets the config back for a screen with a guid that
    was registered against a branch
  x-api-slug: apiscreenzconfigscreenid-get
  description: Gets the config back for a screen with a guid that was registered against
