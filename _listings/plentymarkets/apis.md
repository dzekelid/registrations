...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/registrations/master/_listings/plentymarkets/apis.md
...
- name: plentymarkets REST-API - Get all registered reference types.
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/registrations/master/_listings/plentymarkets/restlogsreference-types-get-openapi.md
- name: plentymarkets REST-API - Get all registered reference types.
  x-api-slug: restlogsreference-types-get
  description: Get all registered reference types..
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/plentymarkets.png
